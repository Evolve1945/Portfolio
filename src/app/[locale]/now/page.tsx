...
const blocks: Record<Locale, { h: string; items: string[] }[]> = {
  en: [
    ...
    },
    {
      ...
      items: [
        ...
        "Xavier Niel, entretiens avec Jean Louis Missika — Une sacrée envie de foutre le bordel— entrepreneurship & strategy",
  ...
  fr: [
    ...
    },
    {
      h: "Je lis",
      items: [
        "Robert Greene — The 48 Laws of Power, The 50th Law (avec 50 Cent), The Art of Seduction, Mastery, The 33 Strategies of War, The Laws of Human Nature, The Daily Laws — strategie & influence",
        "Dale Carnegie — How to Win Friends & Influence People — communication",
        ...
        "Clément Viktorovich — Le pouvoir rhétorique — influence & argumentation",
        "Xavier Niel, entretiens avec Jean Louis Missika — Une sacrée envie de foutre le bordel— entrepreneurship & strategie",
