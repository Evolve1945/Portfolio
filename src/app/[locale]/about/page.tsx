...
const bio: Record<Locale, string[]> = {
  en: [
    "I'm a computer-engineering student at EFREI Paris — born and based in Paris. I found programming in an intro tech class around 15, chased that curiosity into the CS specialism (NSI), and pushed my grade from 12 to 16 along the way. Today I specialize in Python and web development, with working knowledge of C, SQL, Git and Linux.",
    "I think like an architect: give me a goal and I'll find a path to build it, adapting to the resources at hand, the skills on the team, and how each person likes to work. I learn by building real projects rather than waiting for a course — and I keep sharpening that with a programming mentor whom I check in with and a few very talented classmates I build alongside.",
    "I'm actively exploring different areas of engineering to discover where I want to specialize — aiming to go deep on one thing while staying broad across many. I'd like to start inside a strong, ambitious team — people sharper than me, who genuinely care about their ideas — before eventually building something of my own. I'm looking for a developer apprenticeship (alternance) for 2028, open to an internship before then, and preparing an international exchange during my studies.",
  ],
  fr: [
    "Je suis étudiant en cycle ingénieur informatique à l'EFREI Paris — né et basé à Paris. J'ai découvert la programmation en cours de SNT, en seconde ; j'ai suivi cette curiosité jusqu'à la spécialité NSI, en faisant passer ma moyenne de 12 à 16. Aujourd'hui je me spécialise en Python et développement web, avec des connaissances pratiques en C, SQL, Git et Linux.",
    ...
    "J'explore activement différents domaines de l'ingénierie pour déterminer dans lequel je souhaite me spécialiser. — avec l'idée d'aller en profondeur sur un domaine tout en restant large sur beaucoup d'autres. J'aimerais commencer dans une équipe solide et ambitieuse — des gens plus affûtés que moi, qui tiennent vraiment à leurs idées — avant de bâtir un jour quelque chose à moi. Je recherche une alternance de développeur pour 2028, ouvert à un stage d'ici là, et je prépare un échange international pendant mes études.",
  ],
};
